...
//获取所有品牌接口方法
export const reqTrademarkList = () => request.get<any, any>(API.TRADEMARK_LIST_URL)

//获取已有品牌的接口方法
//page: 获取第几页 --- 默认第一页
//limit: 获取几个已有品牌的数据
export const reqHasTrademark = (page: number, limit: number) => request.get<any, TradeMarkPageResponseData>(API.TRADEMARK_URL + `${page}/${limit}`)
